        ...
        public List<Registro> GetRegistros()
        {
            ...
            if (dt.Rows.Count>0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    registro.DescripcionActividad = dt.Rows[i]["descripcion"].ToString();
        ...
        public List<Actividad> GetActividades()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    actividad.IdActividad = Convert.ToInt32(dt.Rows[i]["idActividad"]);
                    actividad.NombreActividad = dt.Rows[i]["nombreActividad"].ToString();
                    actividad.Descripcion = dt.Rows[i]["descripcion"].ToString();
